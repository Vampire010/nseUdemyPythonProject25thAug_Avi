...
class OptionChainFetcher:
    def __init__(self, symbol=SYMBOL, expiry=EXPIRY_DATE):
        self.symbol = symbol
        self.expiry = expiry
    ...
    def fetch_data(self):
        ...
        #print("✅ Data fetched response : " + response.text)
...
if __name__ == "__main__":
    fetcher = OptionChainFetcher(symbol=SYMBOL, expiry=EXPIRY_DATE)
    fetcher.run()